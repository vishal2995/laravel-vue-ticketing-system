    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
      ...
      <form @submit.prevent="onSubmit">
        ...
        <div class="mb-4">
          ...
          <input v-model="formData.confirm_password" type="password" id="confirm_password" name="confirm_password"
            class="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div class="text-center text-sm text-gray-500">
        <p>
          ...
          <a href="/login" class="text-blue-600 hover:underline">Click here to Sign in</a>
        </p>
      </div>
    </div>
  </div>
